...
class JobEntryWidget(QtWidgets.QWidget):
  ...
  def __init__(
    ...
    icons.set_icon(self.ui.btn_cancel_job, model_definitions.IconsEnum.CANCEL, size=QtCore.QSize(24, 24))
...
class JobNotificationWidget(QtWidgets.QWidget):
  ...
  def __init__(
    ...
    if self.job_base_information.job_progress == model_definitions.JobStatus.FINISHED:
      ...
      if job_is_from_current_project:
        ...
        self.ui.btn_open_image.hide()
        self.ui.btn_clear.hide()
      if a_job_base_information_object.job_type == model_definitions.JobType.RAY_TRACING:
        self.ui.btn_refresh.hide()
        self.ui.btn_open.hide()
        self.ui.btn_clear.hide()
        self.ui.btn_open_image.show()
        self.ui.btn_open_image.setText("Show")
    elif self.job_base_information.job_progress == model_definitions.JobStatus.FAILED:
    ...
    self.ui.lbl_icon.setAlignment(Qt.AlignmentFlag.AlignCenter)
