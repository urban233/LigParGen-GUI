...
ICON_PATHS = {
  ...
  "MUSIC_NOTE": pathlib.Path(f"{_icons_root_path}/music_note_w200.svg"),
  "ALBUM": pathlib.Path(f"{_icons_root_path}/album_w200.svg"),
  "ARTIST": pathlib.Path(f"{_icons_root_path}/artist_w200.svg"),
  "TIDAL": pathlib.Path(f"{_icons_root_path}/tidal_64.png"),
